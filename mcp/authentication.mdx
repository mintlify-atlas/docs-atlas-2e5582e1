...
Searches the gateway's available tools on demand using a natural-language query. Returns tool names, descriptions, argument signatures, and source information.
