...
In this guide, the example agent demonstrates a real [Lethal Trifecta](https://www.archestra.ai/docs/platform-lethal-trifecta) attack path:
...
<Steps>
  <Step title="Get Your LLM Provider API Key">
    This example uses OpenAI. Archestra supports multiple providers — see [Supported LLM Providers](https://www.archestra.ai/docs/platform-supported-llm-providers) for the full list.
